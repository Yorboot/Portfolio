...
<main class="flex h-[80vh] justify-center flex-col items-center">
    <h1 class="text-4xl mb-5">About me</h1>
    <p>I am Roy Grizell 17y/o Nerd, I love gaming and Sports, I have interrest in computers/software.</p>
    <p>I am a software dev student year 1 at: curio Breda.</p>
</main>
@include('footer')
</body>
